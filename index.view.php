...
<div class="block md:flex -mx-2">
    ...
    <div class="w-full sm:w-1/2 md:w-1/2 px-2 mt-4">
        <div class="p-6 bg-gray-200 border-b-4 border-gray-400 text-white rounded-lg shadow-lg">
            ...
            <p class="mt-1 text-gray-700 font-light">Example: <a href="https://wildcard.fun/cat/400/600" target="_blank" class="underline text-green-600 font-bold">https://wildcard.fun/cat/400/600</a> - will result in a random cat image.</p>
