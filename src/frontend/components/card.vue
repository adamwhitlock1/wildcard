<template>
  ...
  >
    ...
    <div class="w-1/2 p-1 flex-no-wrap">
      ...
      <div
        class="mt-3 text-gray-100 bg-green-700 h-30 rounded font-light px-4 py-3 border-green-300 border-b-4 shadow-lg"
      >
        ...
        <p class="font-light align-baseline text-xs">
          {{ exampleDescription }}
        </p>
      </div>
    </div>
